        ...
        <div className="flex flex-col w-full h-full bg-bg overflow-hidden relative">
            ...
            <header className="flex justify-between items-center px-5 pt-1 pb-3 relative z-50">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-white text-2xl md:text-3xl font-bold font-display tracking-tight">TCU小幫手</h1>
                </div>
                ...
                <div className="relative">
                    ...
                    {showProfile && (
                        <div className="absolute top-12 right-0 w-[280px] bg-[#1a1a1a] border border-white/10 rounded-2xl shadow-2xl p-4 animate-in fade-in slide-in-from-top-2 z-50">
                            {athlete ? (
            ...
            {/* 可滾動內容區 */}
            <main className="flex-1 overflow-y-auto flex flex-col gap-6 pb-24 md:pb-6 scrollbar-hide" onClick={() => setShowProfile(false)}>
                {/* 精選卡片 */}
                <section
