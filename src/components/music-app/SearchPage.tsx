    ...
    return (
        <div className="flex flex-col w-full h-full bg-bg overflow-hidden relative">
            ...
            <header className="px-5 pt-3 pb-4">
                <h1 className="text-white text-3xl md:text-4xl font-bold font-display mb-4">搜尋</h1>
            ...
            {/* 可滾動內容區 */}
            <main className="flex-1 overflow-y-auto px-5 flex flex-col gap-6 pb-24 md:pb-6 scrollbar-hide">
                {/* 熱門搜尋 */}
                <section>
