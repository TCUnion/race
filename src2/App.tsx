...
function App() {
    ...
    return (
        <>
            {/* 桌面版：置中的手機模擬器 */}
            <div className="hidden md:min-h-screen md:bg-bg-dark md:flex md:items-center md:justify-center font-sans antialiased text-text selection:bg-accent/30 box-border">
            ...
            {/* 手機版：全螢幕 */}
            <div className="md:hidden min-h-screen bg-bg-dark font-sans antialiased text-text selection:bg-accent/30 box-border">
                {renderView()}
            </div>
        </>
    );
